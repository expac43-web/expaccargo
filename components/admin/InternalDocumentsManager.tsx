...
/**
 * Gestion des documents internes (staff) — partagé entre l'admin et le gérant.
 * Les routes /api/admin/* utilisées autorisent SUPER_ADMIN, MANAGER (et AGENCY
 * en lecture), donc le gérant peut déposer des documents pour les agents et les
 * autres gérants exactement comme l'admin.
 */
export default function InternalDocumentsManager() {
