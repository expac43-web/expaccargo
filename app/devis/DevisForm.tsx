              ...
              <div className="lg:col-span-1">
                <div className="sticky top-24 space-y-4">
                  ...
                  <div className="rounded-2xl p-6" style={{ background: "linear-gradient(135deg, #0e2248 0%, #1A3A6B 100%)" }}>
                    ...
                    <a href="mailto:support@expaccargo.com" className="flex items-center gap-2 text-sm text-blue-200 hover:text-white transition-colors" style={{ fontFamily: "var(--font-lato)" }}>
                      <Mail size={14} className="shrink-0" />support@expaccargo.com
                    </a>
                  </div>
