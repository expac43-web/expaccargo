...
export default function GerantProfilPage() {
  ...
  async function handleSave() {
    ...
    setSaving(true);
    const r = await fetch("/api/gerant/profile", {
      method: "PATCH",
    ...
    <div className="p-6 lg:p-8 max-w-2xl">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm mb-5 flex justify-center">
        <AvatarUpload
          avatarUrl={avatarUrl}
          name={profile?.name ?? ""}
          uploadEndpoint="/api/gerant/profile/avatar"
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-black text-sm" style={{ color: "#1A3A6B", fontFamily: "var(--font-montserrat)" }}>{profile?.name}</p>
            <span className="text-xs font-black px-2 py-0.5 rounded-full" style={{ backgroundColor: "rgba(232,82,10,0.1)", color: "#E8520A", fontFamily: "var(--font-montserrat)" }}>
              Gérant
            </span>
          </div>
        </div>
            ...
            <div key={field}>
              ...
              <div className="relative">
                ...
                <input type={show ? "text" : "password"} value={form[field]}
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-[#1A3A6B] focus:ring-2 focus:ring-[#1A3A6B]/10 transition-all bg-white"
                  style={{ fontFamily: "var(--font-lato)" }} />
